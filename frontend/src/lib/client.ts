...
export function Environment(name: string): BaseURL {
    return `https://${name}-vercel-app-789i.encr.app`
}
...
/**
 * Client is an API client for the vercel-app-789i Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "vercel-app-789i-Generated-TS-Client (Encore/v1.42.1)";
        }
